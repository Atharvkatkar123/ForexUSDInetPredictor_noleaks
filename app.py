...
import csv
import sys
sys.path.append(r"C:\Users\katka\Downloads\models_forex\currency_model_pipeline")
...
# Configuration
BASE_DIR = os.path.abspath(r'C:\Users\katka\Downloads\models_forex')
...
@app.route('/')
def serve_html():
    return send_from_directory(BASE_DIR, 'interface_try.html')
...
def prediction_loop():
    global rolling_df, news_df,jpy1, gbp1, eur1
    for i in range(30):
        print(f"\n[INFO] Prediction iteration {i + 1}/30")
